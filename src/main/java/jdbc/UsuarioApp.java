...
public class UsuarioApp {
	...
	public static void main(String[] args) {
		...
		System.out.println("Available Connections" + 		SingletonPoolConn.getInstance().availableConnections());
		System.out.println("UnAvailable Connections" + 		SingletonPoolConn.getInstance().unavailableConnections());
